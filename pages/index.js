...
export default function Home() {
  return (
    <div className={styles.background}>
      <Layout home>
        <Header />
        <div className="w-full h-screen flex items-center px-10 lg:px-32 bg-primary text-black">
          <section className="w-full">
            <span className="font-bold uppercase tracking-widest text-white">
              Introducing
            </span>
            <h1
              className="text-6xl lg:text-10xl mb-3 mt-1 w-96 h-16 font-bold text-transparent bg-clip-text bg-gradient-to-br from-purple-400 to-blue-700"
              id="title"
        ...
        >
          <section className="container mx-auto px-6 p-10">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-3 px-2 py-2 gap-3">
              ...
              >
                <div className="text-center">
                  ...
                  <div>
                    Set timers and mass notify members for server events.
                  </div>
                </div>
              </div>
              <div
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(141.48deg,#f837ee 1.35%,#ffcd4b)",
                }}
              >
                <div className="text-center">
                  <h2 className="text-2xl font-bold uppercase">
            ...
            <h2 className="text-2xl font-bold text-center text-white mt-16">
